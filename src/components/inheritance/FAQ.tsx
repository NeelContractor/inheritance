      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        <AccordionItem value="item-1" className="border-none bg-zinc-900/50 rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline text-white py-4">
            How does Inheritance Key work?
          </AccordionTrigger>
          <AccordionContent className="text-zinc-400 pb-4">
            Inheritance uses smart contracts on the Solana blockchain to create a secure, automated inheritance system. 
        ...
        <AccordionItem value="item-2" className="border-none bg-zinc-900/50 rounded-lg px-4">
          ...
          <AccordionContent className="text-zinc-400 pb-4">
            ...
            You maintain full control over your assets while the escrow is active. Once the time is up, only the beneficiary wallet can withdraw the assets.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-3" className="border-none bg-zinc-900/50 rounded-lg px-4">
          ...
          <AccordionContent className="text-zinc-400 pb-4">
            Yes, alot. Inheritance is built on Solana&apos;s blockchain, ensuring maximum security and transparency. 
        ...
        <AccordionItem value="item-4" className="border-none bg-zinc-900/50 rounded-lg px-4">
          ...
          <AccordionContent className="text-zinc-400 pb-4">
            You can verify the code and smart contract by checking the source code on <a href="https://github.com/NeelContractor/inheritance" className="underline">Github</a>.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
