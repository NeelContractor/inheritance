...
import { Calendar, Clock, User, Coins, Shield, AlertTriangle } from 'lucide-react';
                    ...
                    {accounts.data.map((account) => (
                        ...
                        <CardContent className="pt-6">
                            ...
                            {/* <div className="space-y-2">
                                ...
                                {formatSOL(account.account.lamports || 0)} SOL
                                </p>
                            </div> */}
                            </div>
        ...
        <Card>
            ...
            <CardContent>
                <div className="space-y-4">
                    ...
                    <Button onClick={handleInitialize} disabled={initialize.isPending} className="w-full">
        ...
        <Card className="border-green-200">
            ...
            <CardContent>
                ...
                <div className="space-y-4">
                    ...
                    <Button onClick={handleClaim} disabled={claim.isPending} className="w-full bg-green-600 hover:bg-green-700">
                        {claim.isPending ? 'Claiming...' : 'Claim Inheritance'}
                    </Button>
                </div>
            </CardContent>
        </Card>
        ...
        <Card className="border-red-200">
            ...
            <CardContent>
                ...
                <div className="space-y-4">
                    ...
                    <Button onClick={handleCancel} disabled={cancel.isPending} variant="destructive" className="w-full">
                        {cancel.isPending ? 'Cancelling...' : 'Cancel Escrow'}
                    </Button>
                </div>
            </CardContent>
        </Card>
